...
class BoardTopicsTests(TestCase):
    ...
    # https://simpleisbetterthancomplex.com/series/2017/09/18/a-complete-beginners-guide-to-django-part-3.html#testing-the-form-view
...
class NewTopicTests(TestCase):
    ...
    # https://simpleisbetterthancomplex.com/series/2017/09/18/a-complete-beginners-guide-to-django-part-3.html#adding-more-tests
